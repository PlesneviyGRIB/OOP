...
public class EchoNonblockingServer {
        ...
        while (true) {
            ...
            while (iterator.hasNext()) {
                ...
                if (key.isReadable()) {
                    ...
                    try {
                        map.get(sc).sendMessage(message);
                    }catch (Exception e){
                    ...
                    System.out.println("Message transferred to server: " + message);
                }

                String str;
                if(!(str = serverHasResponse(map.get(sc))).equals("")){
    ...
    private String serverHasResponse(NonblockingClient client) throws Exception {
